...
`;var H=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let M={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},j={lg:"lg",md:"md",sm:"sm"},F=class extends i.WF{constructor(){super(...arguments),this.imageSrc="",this.text="",this.size="lg",this.type="text-dropdown",this.disabled=!1}render(){return(0,i.qy)`<button ?disabled=${this.disabled} data-size=${this.size} data-type=${this.type}>
      ${this.imageTemplate()} ${this.textTemplate()}
      <wui-flex class="right-icon-container">
        <wui-icon name="chevronBottom"></wui-icon>
      </wui-flex>
    </button>`}textTemplate(){let e=M[this.size];return this.text?(0,i.qy)`<wui-text color="primary" variant=${e}>${this.text}</wui-text>`:null}imageTemplate(){if(this.imageSrc)return(0,i.qy)`<wui-image src=${this.imageSrc} alt="select visual"></wui-image>`;let e=j[this.size];return(0,i.qy)` <wui-flex class="left-icon-container">
      <wui-icon size=${e} name="networkPlaceholder"></wui-icon>
    </wui-flex>`}};F.styles=[f.W5,f.fD,T],H([(0,r.MZ)()],F.prototype,"imageSrc",void 0),H([(0,r.MZ)()],F.prototype,"text",void 0),H([(0,r.MZ)()],F.prototype,"size",void 0),H([(0,r.MZ)()],F.prototype,"type",void 0),H([(0,r.MZ)({type:Boolean})],F.prototype,"disabled",void 0),F=H([(0,v.E)("wui-select")],F),o(44036),o(41163);var B=o(91867),L=o(91549);let Z=(0,y.AH)`
  wui-image {
...
`;var q=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let V=class extends i.WF{constructor(){super(),this.unsubscribe=[],this.paymentAsset=L.PayController.state.paymentAsset,this.amount=L.PayController.state.amount,this.unsubscribe.push(L.PayController.subscribeKey("paymentAsset",e=>{this.paymentAsset=e}),L.PayController.subscribeKey("amount",e=>{this.amount=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=l.W.getAllRequestedCaipNetworks().find(e=>e.caipNetworkId===this.paymentAsset.network);return(0,i.qy)`<wui-flex
    ...
    </wui-flex>`}};V.styles=[Z],q([(0,r.MZ)()],V.prototype,"paymentAsset",void 0),q([(0,r.MZ)()],V.prototype,"amount",void 0),V=q([(0,y.EM)("w3m-pay-header")],V);let U=(0,y.AH)`
  :host {
    height: 60px;
  }
